...
При составления запроса пользуются правилом "чем больше слов — тем лучше", и не знают приемов работы с поисковыми системами. Предпочтение отдают только одному поисковику и не знают особенностей различных систем.
