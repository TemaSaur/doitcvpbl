- [Введение](#введение)
- [Глава 1: Теоретические предпосылки формирования ИКТ-компетенции в процессе обучения информатике.](#глава-1-теоретические-предпосылки-формирования-икт-компетенции-в-процессе-обучения-информатике)
	- [1.1 Компетентностный подход в образовании: сущность и содержание понятий «компетентность», «компетенция»](#11-компетентностный-подход-в-образовании-сущность-и-содержание-понятий-компетентность-компетенция)
	- [1.2 Формирование ИКТ-компетенции](#12-формирование-икт-компетенции)
	- [1.3 Проектное обучение как одно из направлений развития образования](#13-проектное-обучение-как-одно-из-направлений-развития-образования)
	- [Выводы по главе 1](#выводы-по-главе-1)
- [Глава 2 Опытно-экспериментальная работа по формированию ИКТ-компетенции](#глава-2-опытно-экспериментальная-работа-по-формированию-икт-компетенции)
	- [2.1 Диагностика начального уровня сформированности ИКТ-компетенции](#21-диагностика-начального-уровня-сформированности-икт-компетенции)
	- [2.2 Работа над проектами](#22-работа-над-проектами)
	- [2.3 Рекомендации по эффективной работе с ИКТ](#23-рекомендации-по-эффективной-работе-с-икт)
		- [2.3.1 Сочетания клавиш](#231-сочетания-клавиш)
		- [2.3.2 Действия в текстовых процессорах](#232-действия-в-текстовых-процессорах)
		- [2.3.3 Онлайн альтернативы текстовых процессоров](#233-онлайн-альтернативы-текстовых-процессоров)
		- [2.3.4 Поиск](#234-поиск)
		- [2.3.5 Нейросети](#235-нейросети)
	- [2.4 Результаты повторного тестирования](#24-результаты-повторного-тестирования)
	- [Выводы по главе 2](#выводы-по-главе-2)
...
На этапе сбора информации самые частые действия, позволяющие использовать сочетания клавиш — копирование и вставка текста, поиск текста на странице, а также переключение активной программы. Кроме того были выбраны такие действия, как: вырезать текст, выделить всё, сохранить, отменить, сделать снимок части экрана, переместить программу, закрыть программу, вставить перенос страницы (для текстовых процессоров).
